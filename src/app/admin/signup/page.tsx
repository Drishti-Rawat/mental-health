...
export default function AdminSignupPage() {
  ...
  return (
    <AuthLayout
      ...
      panelTitle="Management & Operations Portal"
      panelDescription="Apply for Supervisor or Admin role credentials. All administrative accounts undergo credential verification before account activation."
      features={[
        'Strict Administrative Credential Verification',
        'Role-Based Operational Access Control',
        'System Auditing & Platform Management',
      ]}
      formTitle="Administrative Signup"
      formSubtitle="Select your role and request administrative access"
    >
      {error && (
