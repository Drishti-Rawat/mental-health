...
const servicesData = [
  {
    ...
    href: "/book?specialty=Anxiety%20%26%20Stress",
    icon: Brain,
  ...
  },
  {
    ...
    href: "/book?specialty=Relationship%20Counselling",
    icon: Heart,
    theme: "bg-white text-foreground border border-black/[0.05] shadow-sm",
    iconTheme: "text-secondary bg-secondary/10",
    linkTheme: "text-secondary hover:text-secondary/80 border-secondary/20 hover:border-secondary",
  },
  {
    ...
    href: "/book?specialty=Child%20%26%20Adolescent%20Therapy",
    icon: Users,
    theme: "bg-white text-foreground border border-black/[0.05] shadow-sm",
    iconTheme: "text-secondary bg-secondary/10",
    linkTheme: "text-secondary hover:text-secondary/80 border-secondary/20 hover:border-secondary",
  },
  {
    ...
    href: "/book?specialty=Trauma%20%26%20PTSD",
    icon: Sparkles,
    theme: "bg-white text-foreground border border-black/[0.05] shadow-sm",
    iconTheme: "text-secondary bg-secondary/10",
    linkTheme: "text-secondary hover:text-secondary/80 border-secondary/20 hover:border-secondary",
  },
  {
    ...
    href: "/book?specialty=Career%20%26%20Growth",
    icon: Target,
    theme: "bg-white text-foreground border border-black/[0.05] shadow-sm",
    iconTheme: "text-secondary bg-secondary/10",
    linkTheme: "text-secondary hover:text-secondary/80 border-secondary/20 hover:border-secondary",
  },
  {
    ...
    href: "/book?specialty=Self%20Care%20%26%20Wellbeing",
    icon: Heart,
    theme: "bg-white text-foreground border border-black/[0.05] shadow-sm",
    iconTheme: "text-secondary bg-secondary/10",
    linkTheme: "text-secondary hover:text-secondary/80 border-secondary/20 hover:border-secondary",
