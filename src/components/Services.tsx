  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center text-center mb-10 mt-16">
        <span className="inline-block bg-secondary/10 text-foreground font-semibold text-[11px] tracking-wider uppercase rounded-full px-4 py-1.5 mb-3">
          What We Help With
        </span>
        <h2 className="font-serif text-3xl md:text-4xl font-bold text-secondary mb-3 max-w-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
        {servicesData.map((service) => (
          <div
            key={service.id}
            className={`rounded-2xl p-6 flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] ${service.theme}`}
          >
            <div>
