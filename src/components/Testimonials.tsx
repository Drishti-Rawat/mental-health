...
export default function Testimonials() {
  ...
  return (
    <>
      <div className="bg-tertiary rounded-[2rem] p-8 lg:p-12 flex flex-col lg:flex-row gap-10 lg:gap-0 shadow-sm relative overflow-hidden">
        {/* Left Block: Rating */}
        <div className="lg:w-[25%] shrink-0 flex flex-col justify-center items-start lg:pr-8 border-b md:border-b-0 lg:border-r border-black/5 pb-8 lg:pb-0">
          ...
          <h3 className="text-5xl md:text-6xl font-bold text-[#1a3d31] mb-3 tracking-tight">4.8/5</h3>
        ...
        <div className="lg:w-[75%] overflow-hidden relative">
          ...
          >
            {slides.map((slide, slideIndex) => (
              <div key={slideIndex} className="w-full shrink-0 flex flex-col md:flex-row gap-8 md:gap-0 h-full">
                {slide.map((t, idx) => (
                  <div
                    key={idx}
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between h-full">
                      <p className="text-xs md:text-[13px] text-foreground/70 leading-relaxed mb-2 font-medium">
                        {t.text}
                      </p>
